    ...
    var i = n(3),
        ...
        s = function() {
            ...
            return _createClass(e, [{
                ...
                key: "close",
                value: function() {
                    console.log(this.activator, $(this), "close");
                    $(this.activator).find("svg").css("transform", "rotate(0deg)");
            ...
            },
            {
                key: "open",
                value: function() {
                    console.log(this.activator, $(this), "open");
                    $(this.activator).find("svg").css("transform", "rotate(180deg)");
                    // if(!$("body").hasClass('stop-scroll'))
                ...
                value: function() {
                    ...
                    // }),
                     fastdom.mutate(function() {
                        ...
                        }), e.element.classList.add("Popover--position" + (i.charAt(0).toUpperCase() + i.slice(1))), e.element.classList.add("Popover--align" + (a.charAt(0).toUpperCase() + a.slice(1)))
                    })
                }
            }, {
                key: "_handleKeyboard",
            ...
            return _createClass(e, [{
                ...
                value: function(e, t) {
                    ...
                    if (e) {
                        ...
                        var testt = r["default"].formatMoney(e.price, window.theme.moneyFormat)
                        var price = testt.substr(1,testt.length);
                        var testt2 = r["default"].formatMoney(e.compare_at_price, window.theme.moneyFormat)
                        var comparePrice = testt2.substr(1,testt2.length);
                        var diff = ((comparePrice - price) / comparePrice) * 100;
                        diff = Math.round(diff * 100) / 100;
                        console.log(comparePrice, price, diff+"%");
                        n.innerHTML = "", e.compare_at_price > e.price ? (n.innerHTML += '<span class="ProductMeta__Price Price Price--highlight Text--subdued u-h4" data-money-convertible>' + r["default"].formatMoney(e.price, window.theme.moneyFormat) + "</span>", n.innerHTML += '<span class="ProductMeta__Price Price Price--compareAt Text--subdued u-h4" data-money-convertible>' + r["default"].formatMoney(e.compare_at_price, window.theme.moneyFormat) + "</span>", n.innerHTML += '<span class="ProductMeta__Price Price Price--discounted" data-money-convertible>' + diff +"%" + "</span>") : n.innerHTML += '<span class="ProductMeta__Price Price Price--highlight Text--subdued u-h4" data-money-convertible>' + r["default"].formatMoney(e.price, window.theme.moneyFormat) + "</span>", n.style.display = ""
